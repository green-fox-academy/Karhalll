...
listOfNames.forEach(function (name) { return console.log(name); });
listOfNames.forEach(function (name, index) { return console.log(index + 1 + ". " + name); });
listOfNames.splice(3, 1);
listOfNames.reverse().forEach(function (name) { return console.log(name); });
